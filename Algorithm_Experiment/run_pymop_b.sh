...
CLONE_DIR="${DEVELOPER_ID}-${TESTING_REPO_NAME}_PyMOP_B"
...
cp $TESTING_REPO_NAME/D-full.json $CLONE_DIR/B-full.json
cp $TESTING_REPO_NAME/D-time.json $CLONE_DIR/B-time.json
cp $TESTING_REPO_NAME/D-violations.json $CLONE_DIR/B-violations.json
